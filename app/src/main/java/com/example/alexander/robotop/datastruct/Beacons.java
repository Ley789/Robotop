...
public class Beacons {
    ...
    private final static Point[] position = {new Point(125,125), new Point(125,0),new Point(125,-125),
                                             new Point(-125,0), new Point(-125,-125),new Point(-125,0),
                                             new Point(-125,125), new Point(0,125)};
    //mapping indexes
    //convention red = 0, yellow =1, with=2, blue=3
    private final static Pair[] colorIndex = {new Pair(0,1), new Pair(2,0), new Pair(1,0),new Pair(0,3), new Pair(1,3),
